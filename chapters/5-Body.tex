...
\begin{itemize}
	...
	\item \textbf{QNX:} modular and POSIX-compilant RTOS is preferred in the medical and automotive sector (infotainment systems) for error tolerance and reliability. As of short notice, the \textbf{Blackbery 10} OS is based on QNX.
