...
\label{cite:mastering}
\cite{mastering}  Richard Barry and The FreeRTOS Team mentions in the manual a concise description for what a scheduling algorithm depicts, \enquote{The scheduling algorithm is the software routine that decides which Ready state task to transition into the Running state.}
