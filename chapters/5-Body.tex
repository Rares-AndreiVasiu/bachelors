...
\begin{enumerate}[]
	...
	\item \textbf{Firm:} production of results after its end time has no use for the system, but does not inflict damage.
	
	\item \textbf{Hard:} when results are obtained after the specified time limit, the control unit faces a doomsday scenario.
